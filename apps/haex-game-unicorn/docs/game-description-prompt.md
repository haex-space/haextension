...
- Summer: The first tiny workers hatch. The child now plays as a worker bee - flying through the meadow collecting pollen and nectar, pollinating flowers, avoiding predators (cuckoo bumblebees, crab spiders, wool carder bees). The bumblebee can do "buzz pollination" - vibrating on special flowers like tomatoes to shake loose pollen that honeybees cannot reach.
- Autumn: The colony produces new queens and drones. The old colony dies. Young queens mate and dig into the earth to hibernate.
- Winter: The meadow is quiet. Snow falls. Under the earth, a queen sleeps until spring.
...
- Nature-accurate and biologically correct - children should learn real biology through playing
- The world is never still: grass sways in the wind, butterflies flutter by, clouds drift across the sky, light changes with the time of day
- Parallax scrolling for depth: distant mountains move slowly, foreground grass moves fast
- Seasonal changes affect everything: colors, weather, which animals are active, which flowers bloom
- Child-friendly but not dumbed down: cute AND realistic

The art should make a child want to explore every corner of this world. It should feel like a living, breathing meadow - not a game board.

All sprites need transparent backgrounds (PNG) and consistent style across all assets.
