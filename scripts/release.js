...
const KNOWN_EXTENSIONS = ['haex-pass', 'haex-pass-browser', 'haex-files', 'haex-calendar', 'haex-code', 'haex-draw', 'haex-notes', 'haex-image', 'haex-tetris', 'haex-mail', 'haex-game-unicorn'];
